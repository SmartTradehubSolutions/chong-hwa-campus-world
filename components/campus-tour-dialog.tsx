 ...
 return <Dialog open={!!tour} onOpenChange={open=>{if(!open)onChange(null);}}>
  <DialogContent className="panorama-dialog">
   ...
   <div className="tour-navigation">
    ...
    <div className="tour-actions"><button onClick={()=>onChange(null)}><ArrowLeft size={16}/> Back to campus</button><a href={place?.source||SOURCE} target="_blank" rel="noreferrer">Official school source <ArrowUpRight size={14}/></a></div>
